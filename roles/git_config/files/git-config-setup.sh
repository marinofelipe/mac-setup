...
git config --global alias.aliases "!sh ~/.scripts/git-aliases.sh"
git config --global alias-doc.branches '# Displays all configured aliases alongside their explanation'
...
git config --global alias-doc.logs '# Runs lazygit, a terminal UI for git commands'

git config --global alias.summary "! lazygit"
git config --global alias-doc.logs '# Summarizes repository statistics and information'
